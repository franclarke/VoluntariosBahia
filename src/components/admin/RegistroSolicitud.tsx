...
export default function RegistroSolicitud() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.direccion || !formData.tipoArticulo || !formData.cantidad || !formData.contactoNombre || !formData.contactoTel) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="tipoArticulo">Tipo de artículo necesitado *</Label>
        <Select 
